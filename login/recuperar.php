	...
	<body>
		...
		<div class="content">
			<div class="center-block">
				...
				<div class="row">
					<form method="post" id="cambiarPsw" name="cambiarPsw" class="form-horizontal col-xs-offset-1 col-xs-10 col-xs-offset-1 col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6 col-lg-offset-4 col-lg-4" role="form" novalidate>
