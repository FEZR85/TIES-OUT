				...
				<div class="row cursos">
					<div class="col-md-4 verde"  >
						<article>					
							...
							<a class="btn btn-default" href="<?php echo ROOTPATH ?>/app/Vistas/acurso1.php" role="button">Ver más...</a>
						</article>
					</div>
					<div class="col-md-4 cafe">
						<article>					
							<h3>Árboles</h3>
							<p>Un árbol es una estructura no lineal en la que cada nodo puede apuntar a uno o varios nodos. También se suele dar una definición...</p>
							<a class="btn btn-default" href="<?php echo ROOTPATH ?>/app/Vistas/curso1.php" role="button">Ver más...</a>
						</article>
					</div>
					...
					<div class="col-md-4 naranja" >
						<article>					
							<h3>Árboles</h3>
							<p>Un árbol es una estructura no lineal en la que cada nodo puede apuntar a uno o varios nodos. También se suele dar una definición...</p>
							<a class="btn btn-default" href="<?php echo ROOTPATH ?>/app/Vistas/curso2.php" role="button">Ver más...</a>
						</article>
					</div>
				</div>
			</div>
